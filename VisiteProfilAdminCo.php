...
<head>
	...
	<meta charset="utf-8">
	<link href="VisiteProfilAdmin.css" rel="stylesheet" type="text/css"/>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="section">
			<?php 
			$sql = "SELECT * from administrateur WHERE nom = '$nom_admin' and prenom = '$prenom_admin'";
			...
			?>
			<h2>Administrateur -> <?php echo $data['prenom'].' '.$data['nom']; ?> </h2>
			...
			$valeur = $data['id_admin'];
			$requeteVend = "SELECT * from article_admin where $valeur = article_admin.id_admin";
					...
					<table align=center border=1>
						...
						<tr align=center>
			                <td colspan="2">
			                    ...
			                    echo "<a href='AjouterPanierAcheteurAdminVisite.php?id_article=".$var." '>Ajouter au panier</a>";
			                    ?>
			                </td>
			            </tr>
