...
<div id="section" align=center>
    ...
    while ($ligne = $resultat -> fetch_assoc()) {
        if ($ligne['categorie_type'] == "insolites") {
        ?>
    <form action="AjouterInsolitesPanierAcheteurAdmin.php">
        <table>
            <tr align=center>
                <td colspan='2'>
                    <?php
            ...
            <tr align=center>
                <td colspan="2">
                    ...
                    echo "<a href='AjouterInsolitesPanierAcheteurAdmin.php?id_article=".$var." '>Ajouter au panier</a>";
                    ?>
                </td>
            </tr>
    ...
    while ($ligne = $resultat -> fetch_assoc()) {
        ...
        <form action="AjouterInsolitesPanierAcheteurAdmin.php" method="post">
            <table>
                <tr align=center>
                    <td colspan='2'>
                        <?php
